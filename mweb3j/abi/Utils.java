...
public class Utils {
    ...
    static <T extends Type> String getTypeName(TypeReference<T> typeReference) {
        try {
            ...
            if (reflectedType instanceof ParameterizedType) {
                ...
                type = Class.forName(((Class) reflectedType).getName());//reflectedType.getTypeName());
    ...
    static <T extends Type> Class<T> getParameterizedTypeFromArray(
        ...
        String parameterizedTypeName = ((Class) typeArguments[0]).getName() ;//typeArguments[0].getTypeName();
